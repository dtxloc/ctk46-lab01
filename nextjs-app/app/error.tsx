  ...
  return (
    <div className="min-h-[70vh] max-w-5xl mx-auto px-4 py-24 text-center flex flex-col items-center justify-center">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          href="/"
          className="border border-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800 transition-colors"
        >
          Về trang chủ
        </Link>
      </div>
